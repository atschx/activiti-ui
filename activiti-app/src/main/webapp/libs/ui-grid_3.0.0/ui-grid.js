                        ...
                        post: function ($scope, $elm, $attrs, controllers) {
                            ...
                            if ($scope.sortable || $scope.colMenu) {
                                ...
                                $contentsElm.on(downEvent, function (event) {
                                    ...
                                    cancelMousedownTimeout = $timeout(function () {
                                    }, mousedownTimeout);
                        ...
                        post: function postlink($scope, $elm, $attrs, controllers) {
                            ...
                            function touchmove(event) {
                                ...
                                if (deltaY !== 0) {
                                    ...
                                    if (scrollYPercentage > 1) {
                                        scrollYPercentage = 1;
                                    }
                                    else if (scrollYPercentage < 0) {
                                        scrollYPercentage = 0;
                                    }
                                ...
                                if (deltaX !== 0) {
                                    ...
                                    if (scrollXPercentage > 1) {
                                        scrollXPercentage = 1;
                                    }
                                    else if (scrollXPercentage < 0) {
                                        scrollXPercentage = 0;
                                    }
                ...
                link: function ($scope, $elm, $attrs, controllers) {
                    ...
                    $elm.on('scroll', function (evt) {
                        ...
                        if (newScrollLeft !== colContainer.prevScrollLeft) {
                            ...
                            if (xDiff > 0) {
                                grid.scrollDirection = uiGridConstants.scrollDirection.RIGHT;
                            }
                            if (xDiff < 0) {
                                grid.scrollDirection = uiGridConstants.scrollDirection.LEFT;
                            }
