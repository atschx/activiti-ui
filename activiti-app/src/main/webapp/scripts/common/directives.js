...
activitiModule.directive('selectPeoplePopover', ['$rootScope', '$http', '$popover', 'appResourceRoot', 'UserService', '$parse', function ($rootScope, $http, $popover, appResourceRoot, UserService, $parse) {
    var directive = {};
    directive.restrict = 'A';
...
activitiModule.directive('selectFunctionalGroupPopover', ['$rootScope', '$http', '$popover', 'appResourceRoot', 'FunctionalGroupService', '$parse',
