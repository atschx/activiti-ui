...
angular.module('activitiModeler').directive('selectGroupPopover', ['$http', '$popover', '$parse', 'GroupService', function ($http, $popover, $parse, GroupService) {
    var directive = {};
...
angular.module('activitiModeler').directive('assignmentSelect', ['$http', '$templateCache', function ($http, $templateCache) {
    ...
    directive.controller = ['$rootScope', '$scope', '$translate', '$element', function ($rootScope, $scope, $translate, $element) {
        $scope.assignmentOptions = [
            {
                id: "initiator",
                title: $translate.instant('PROCESS-BUILDER.FIELD.ASSIGNMENT-SELECT.ASSIGNED-TO-INITIATOR')
            },
            {id: "user", title: $translate.instant('PROCESS-BUILDER.FIELD.ASSIGNMENT-SELECT.ASSIGNED-TO-SINGLE-USER')},
            {
                id: "users",
                title: $translate.instant('PROCESS-BUILDER.FIELD.ASSIGNMENT-SELECT.ASSIGNED-TO-CANDIDATE-USERS')
            }
        ];

        if ($rootScope.account.tenantId !== null && $rootScope.account.tenantId !== undefined) {
            $scope.assignmentOptions.push({
                id: "groups",
                title: $translate.instant('PROCESS-BUILDER.FIELD.ASSIGNMENT-SELECT.ASSIGNED-TO-CANDIDATE-GROUPS')
            });
        }
...
angular.module('activitiModeler').directive('fieldsSelect', ['$http', '$templateCache', function ($http, $templateCache) {
...
angular.module('activitiModeler').directive('recipientSelect', ['$http', '$translate', '$templateCache', function ($http, $translate, $templateCache) {
    ...
    directive.controller = ['$rootScope', '$scope', '$element', function ($rootScope, $scope, $element) {
        $scope.recipientOptions = [
            {
                id: "initiator",
                title: $translate.instant('PROCESS-BUILDER.EMAIL-STEP.RECIPIENT.POPOVER.SELECT-INITIATOR')
            },
